...
urlpatterns = [
    ...
    path("<str:reference>/download-pdf/", SchedulePDFDownloadView.as_view(), name="schedule_download_pdf"),
    path("<str:reference>/share/", ScheduleShareView.as_view(), name="schedule_share"),
